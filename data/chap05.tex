...
% 如图5.3所示,Spark项目包含多个独立组件。在Spark项目当中，最主要的是深蓝色的 SparkCore, 核心API即被SparkCore模块所定义,比如弹性分布式数据集(Resilient Distributed Datasets,RDD),该模块也负责调度、监控计算集群中的计算任务, 具备的功能有内存管理,故障恢复,与管理系统、存储系统交互等。
